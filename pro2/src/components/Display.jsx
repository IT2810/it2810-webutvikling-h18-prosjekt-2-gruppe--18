      ...
      <div>
        ...
        <div id="tab-container">
          <Tab
            ...
            typer={this.state}
            activeStatus={
              this.state.view === "tab1" ? "tab-active" : "tab-inactive"
            }
            name="Tab 1"
          />
          ...
          <Tab
            ...
            typer={this.state}
            activeStatus={
              this.state.view === "tab2" ? "tab-active" : "tab-inactive"
            }
            name="Tab 2"
          />
          ...
          <Tab
            ...
            typer={this.state}
            activeStatus={
              this.state.view === "tab3" ? "tab-active" : "tab-inactive"
            }
            name="Tab 3"
          />
          ...
          <Tab
            ...
            typer={this.state}
            activeStatus={
              this.state.view === "tab4" ? "tab-active" : "tab-inactive"
            }
            name="Tab 4"
          />
